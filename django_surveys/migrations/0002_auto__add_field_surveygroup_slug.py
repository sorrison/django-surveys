...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SurveyGroup.slug'
        db.add_column('django_surveys_surveygroup', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, db_index=True), keep_default=False)
        from django.template.defaultfilters import slugify
        for sg in orm.SurveyGroup.objects.all():
            if not sg.slug:
                sg.slug = slugify(sg.name)
                sg.save()


    def backwards(self, orm):
        
        # Deleting field 'SurveyGroup.slug'
        db.delete_column('django_surveys_surveygroup', 'slug')
