...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('django_surveys_question', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Question.help_text'
        db.delete_column('django_surveys_question', 'help_text')
